...
public class CircleView extends View {
    ...
    private void updateCircleColor() {
        float colorProgress = (float) AnimationUtils.clamp(outerCircleRadiusProgress, 0.5, 1);
        colorProgress = (float) AnimationUtils.mapValueFromRangeToRange(colorProgress, 0.5f, 1f, 0f, 1f);
