...
public class CollageView extends LinearLayout {
    ...
    public CollageView iconSelector(int iconSize) {
                ...
                while (i < size) {
                    ...
                    if (number == photosInLine || size == i + 1) {
                        ...
                        for (int j = 0; j < photosInLine; j++) {
                            ...
                            ImageForm imageForm = useFirstAsHeader && i == 0 || i==8? headerForm : photosForm;
                            ImageView imageView = new RectangleImageView(getContext(), imageForm.IMAGE_FORM_SQUARE);
                            ...
                            String ImgURL=addUrls.get(j);
                            if(ImgURL.contains("-00001.png"))
                            {
